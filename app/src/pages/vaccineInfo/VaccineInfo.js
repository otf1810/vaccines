  ...
  return (
    <>
      <Header
        ...
        placement="center"
        statusBarProps={{}} />
      <ImageBackground source={data.photo} style={{ width: screen.width, height: screen.height / 3 }} />

      <ScrollableTabView style={[t.bgWhite]} renderTabBar={() => <DefaultTabBar />} tabBarActiveTextColor={'#4169E1'} tabBarUnderlineStyle={{ backgroundColor: '#4169E1' }} >
