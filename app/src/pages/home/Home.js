...
import { Card, Divider, Header, ListItem, SearchBar, Image, Avatar, Icon } from 'react-native-elements';
        ...
        {vaccineList.map((vaccine, index) => {
          return (
            <Card key={index} containerStyle={{ width: 370 }} wrapperStyle={{}}>
              ...
              <Card.Divider />
              <Image source={vaccine.img} style={{ width: '100%', height: 150 }} onPress={() => { navigation.navigate('VaccineInfo', { vaccineId: vaccine.id }) }} />
            </Card>
          );
        })}
