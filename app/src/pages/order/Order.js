  ...
  return (
    <>
      <Header
        ...
        leftComponent={{ icon: 'arrow-back', color: "#fff", onPress: () => { Picker.hide(); navigation.goBack(); } }}
        leftContainerStyle={{}}
        placement="center"
        statusBarProps={{}} />
      <View style={[{ width: screen.width, height: 460, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, paddingTop: 15 }, t.bgWhite]}>
        ...
        <Input
          ...
          rightIcon={<Icon name="close" size={20} onPress={() => { setName('') }} />}
          placeholder="请输入姓名"
          value={name}
        ...
        <Input
          ...
          rightIcon={<Icon name="close" size={20} onPress={() => setPhone('')} />}
          placeholder="请输入手机号"
          value={phone}
        ...
        <Input
          ...
          rightIcon={<Icon name="close" size={20} onPress={() => { setTime('') }} />}
          placeholder="请输入手机号"
          InputComponent={() => <DatePicker time={time} setTime={setTime} />}
        />
        <Input
          leftIcon={<Icon name="podium" size={20} color='#4169E1' />}
          rightIcon={<Icon name="close" size={20} onPress={() => { setSite('') }} />}
          placeholder="请输入手机号"
